...
with open(csv_file, 'w+', newline='') as f:
    writer = csv.writer(f)
    writer.writerow(["Timestamp", "Category", "Worker Count", "Patient Count", "Duplicate Patient Count"])

    while True:
        # Reset worker-related counters and lists
        worker_counter = 0
        duplicate_worker_patient_encodings = []
        ...
        if len(captured_encodings) > 0:
            ...
            for filename, encoding in worker_face_encodings:
                ...
                if face_distance[0] < face_recognition_threshold:
                    ...
                    if current_time - last_recognition_time > time_window:
                        ...
                        duplicate_worker_patient_encodings.append(captured_encoding)
                    break
            ...
            writer.writerow([current_time_str, category, worker_counter, patient_counter, duplicate_patient_counter])
