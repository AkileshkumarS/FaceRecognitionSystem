...
worker_images_folder = r"C:\Users\Sarvesh\Downloads\python projects\photos"  # Use forward slashes for paths
...
worker_counter = 0
patient_counter = 0
duplicate_patient_counter = 0

# Function to increase the counters and emit the counts to the webpage
def update_counts():
    global worker_counter, patient_counter, duplicate_patient_counter, last_recognition_time
    while True:
        ...
        if len(captured_encodings) > 0:
            ...
            socketio.emit('update_counts', {
                ...
                'duplicatePatientCount': duplicate_patient_counter
            })

            print("Timestamp:", current_time_str)
            print("Category:", category)
            print("Worker Count:", worker_counter)
            print("Patient Count:", patient_counter)
            print("Duplicate Patient Count:", duplicate_patient_counter)
...
# Start a thread to update counts
update_thread = Thread(target=update_counts)
update_thread.start()
